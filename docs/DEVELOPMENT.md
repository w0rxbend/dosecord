...
Dosecord is being rebuilt in thin, verified slices. The process is defined in
[AGENTS.md](../AGENTS.md) and [AGENTIC_DEVELOPMENT.md](AGENTIC_DEVELOPMENT.md).

Use [ROADMAP.md](ROADMAP.md) as the only delivery order and status source. A
slice may start only when its listed dependencies are green. Use
